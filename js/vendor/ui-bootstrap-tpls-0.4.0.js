        ...
        return {
            link: function (n, a, o) {
                ...
                var l, s = function (t) {
                        ...
                        r ? (r = !1, i || t(n, a, "auto")) : s({
                            height: a[0].scrollHeight + "px"
                        }).then(function () {
                            i || t(n, a, "auto")
                        }), i = !1
                    }, u = function () {
                        i = !0, r ? (r = !1, t(n, a, 0)) : (t(n, a, a[0].scrollHeight + "px"), s({
                            height: "0"
                        }))
                    }
            }
...
]), angular.module("ui.bootstrap.pagination", []).controller("PaginationController", ["$scope",
    function (e) {
                        ...
                        v(s, !0), n.when(f.source(y, t)).then(function (n) {
                            if (e === p.$viewValue) {
                                if (n.length > 0) {
                                    ...
                                    for (var a = 0; n.length > a; a++) t[f.itemName] = n[a], y.matches.push({
